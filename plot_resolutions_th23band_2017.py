...
f1 = ROOT.TFile("root/resdcp0_optimized_long_no.root")
res1 = f1.Get("Res")

f2 = ROOT.TFile("root/resdcp0_optimized_long_q23hi_no.root")
res2 = f2.Get("Res")

f3 = ROOT.TFile("root/resdcp0_optimized_long_q23lo_no.root")
res3 = f3.Get("Res")

f1a = ROOT.TFile("root/resdcp-90_optimized_long_no.root")
res1a = f1a.Get("Res")

f2a = ROOT.TFile("root/resdcp-90_optimized_long_q23hi_no.root")
res2a = f2a.Get("Res")

f3a = ROOT.TFile("root/resdcp-90_optimized_long_q23lo_no.root")
res3a = f3a.Get("Res")


graph_dcp0range = filldiff(res2,res3)
graph_dcp90range = filldiff(res2a,res3a)
...
l1.AddEntry(res1,"sin^{2}#theta_{23} = 0.441 #pm 0.042", "L")
l1.SetBorderSize(0)
l1.SetFillStyle(0)
l1.Draw("same")

res1.SetLineWidth(3)
res1a.SetLineWidth(3)

res1.SetLineStyle(2)
res1a.SetLineStyle(2)
...
outname = "plots/res_dcp_exp_th23band_2017.eps"
c1.SaveAs(outname)

#sin2(2q13) resolution

f1 = ROOT.TFile("root/resth13_optimized_long_no.root")
res1 = f1.Get("Res")

f2 = ROOT.TFile("root/resth13_optimized_long_q23hi_no.root")
res2 = f2.Get("Res")

f3 = ROOT.TFile("root/resth13_optimized_long_q23lo_no.root")
res3 = f3.Get("Res")

res1.SetLineWidth(3)
res1.SetLineStyle(2)

graph_range = filldiff(res2,res1)
...
#res3.SetLineColor(ROOT.kBlue)
#res2.Draw("lsame")
#res3.Draw("lsame")

l2 = ROOT.TLegend(0.5,0.64,0.88,0.7)
l2.AddEntry(res1,"sin^{2}#theta_{23} = 0.441 #pm 0.042", "L")
l2.SetBorderSize(0)
l2.SetFillStyle(0)
l2.Draw("same")

outname = "plots/res_th13_exp_th23band_2017.eps"
c2.SaveAs(outname)

#sin2(q23) resolution

f1 = ROOT.TFile("root/resth23_optimized_long_no.root")
res1 = f1.Get("Res")

f2 = ROOT.TFile("root/resth23_optimized_long_q23hi_no.root")
res2 = f2.Get("Res")

f3 = ROOT.TFile("root/resth23_optimized_long_q23lo_no.root")
res3 = f3.Get("Res")

res1.SetLineWidth(3)
res1.SetLineStyle(2)

graph_range = filldiff(res2,res3)
...
outname = "plots/res_th23_exp_th23band_2017.eps"
c3.SaveAs(outname)

#dmsq resolution

f1 = ROOT.TFile("root/resdm_optimized_long_no.root")
res1 = f1.Get("Res")

f2 = ROOT.TFile("root/resdm_optimized_long_q23hi_no.root")
res2 = f2.Get("Res")

f3 = ROOT.TFile("root/resdm_optimized_long_q23lo_no.root")
res3 = f3.Get("Res")

res1.SetLineWidth(3)
res1.SetLineStyle(2)

graph_range = filldiff(res3,res2)
...
outname = "plots/res_dm_exp_th23band_2017.eps"
c4.SaveAs(outname)
