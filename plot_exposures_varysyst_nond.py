...
for myexp in explist:
      ...
      #No ND
      filename = "root/sens_optimized_long_syst5-10pc_no_exp"+str(myexp)+".root"
      f1 = ROOT.TFile(filename)
      cpvgraph_optimized_long = f1.Get("CPVSig")
      mhgraph_optimized_long = f1.Get("MHSig")
      nvals = cpvgraph_optimized_long.GetN()
      ...
      cpvsig_75_optimized_long_5pc = sorted(cpv_vals_optimized_long)[24]
      cpvsig_50_optimized_long_5pc = sorted(cpv_vals_optimized_long)[49]
      cpvsig_best_optimized_long_5pc = cpv_vals_optimized_long[26]
      mhsig_100_optimized_long_5pc = min(mh_vals_optimized_long)
      mhsig_best_optimized_long_5pc = mh_vals[26]
      cpvlist75_nond.append(cpvsig_75_optimized_long_5pc)
      cpvlist50_nond.append(cpvsig_50_optimized_long_5pc)
      cpvlistbest_nond.append(cpvsig_best_optimized_long_5pc)
      f1.Close()
...
cpvlist75_nond = array('d',cpvlist75_nond)
...
cpvlist50_nond = array('d',cpvlist50_nond)
...
cpvlistbest_nond = array('d',cpvlistbest_nond)
...
g_cpvsig_75_nond = ROOT.TGraph(n,explist,cpvlist75_nond)
...
g_cpvsig_50_nond = ROOT.TGraph(n,explist,cpvlist50_nond)
...
g_cpvsig_best_nond = ROOT.TGraph(n,explist,cpvlistbest_nond)
...
g_cpvsig_75_nond.SetLineStyle(3)
...
g_cpvsig_50_nond.SetLineStyle(3)
...
g_cpvsig_best_nond.SetLineStyle(3)
...
#g_cpvsig_75_nond.SetLineColor(ROOT.kCyan+2)
g_cpvsig_50_nond.SetLineStyle(5)
#g_cpvsig_best_nond.SetLineColor(ROOT.kPink-3)
#g_cpvsig_75_nond.Draw("lsame")
g_cpvsig_50_nond.Draw("lsame")
#g_cpvsig_best_nond.Draw("lsame")
...
l1.AddEntry(g_cpvsig_50_nond,"10% #oplus 5%","L")
l1.SetBorderSize(0)
l1.SetFillStyle(0)
l1.Draw("same")
...
outname = "plots/cpv_exp_syst_2017_nond_50pc.png"
c1.SaveAs(outname)

c2 = ROOT.TCanvas("c1","c1",800,800)
c2.SetLeftMargin(0.15)
h2 = c2.DrawFrame(0,0.0,1500.0,15.0)
...
#g_cpvsig_75_nond.SetLineColor(ROOT.kCyan+2)
#g_cpvsig_50_nond.SetLineStyle(5)
g_cpvsig_best_nond.SetLineStyle(5)
#g_cpvsig_75_nond.Draw("lsame")
#g_cpvsig_50_nond.Draw("lsame")
g_cpvsig_best_nond.Draw("lsame")
...
outname = "plots/cpv_exp_syst_2017_nond_best.png"
c2.SaveAs(outname)
