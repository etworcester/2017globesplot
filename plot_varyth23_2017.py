...
f2 = ROOT.TFile("root/sens_optimized_long_q23hi_no_exp300.root")
cpv2 = f2.Get("CPVSig")
mh2 = f2.Get("MHSig")

f3 = ROOT.TFile("root/sens_optimized_long_oscpar_q23lo_no_exp300.root")
cpv3 = f3.Get("CPVSig")
mh3 = f3.Get("MHSig")

f4 = ROOT.TFile("root/sens_optimized_long_oscpar_q23hi_no_exp300.root")
cpv4 = f4.Get("CPVSig")
mh4 = f4.Get("MHSig")
...
ff2 = ROOT.TFile("root/sens_optimized_long_q23hi_no_exp556.root")
cpv12 = ff2.Get("CPVSig")
mh12 = ff2.Get("MHSig")

ff3 = ROOT.TFile("root/sens_optimized_long_oscpar_q23lo_no_exp556.root")
cpv13 = ff3.Get("CPVSig")
mh13 = ff3.Get("MHSig")

ff4 = ROOT.TFile("root/sens_optimized_long_oscpar_q23hi_no_exp556.root")
cpv14 = ff4.Get("CPVSig")
mh14 = ff4.Get("MHSig")

graph_cpvrange300 = filldiff(cpv3,cpv4)
graph_cpvrange556 = filldiff(cpv13,cpv14)
...
h1 = c1.DrawFrame(-1.0,0.0,1.0,12.0)
...
graph_cpvrange556.SetFillColorAlpha(ROOT.kCyan+1,0.25)
...
t1 = ROOT.TPaveText(0.16,0.78,0.45,0.89,"NDC")
...
l1.AddEntry(cpv3,"sin^{2}#theta_{23} = 0.39","L")
l1.AddEntry(cpv1,"sin^{2}#theta_{23} = 0.441","L")
l1.AddEntry(cpv2,"sin^{2}#theta_{23} = 0.5","L")
l1.AddEntry(cpv4,"sin^{2}#theta_{23} = 0.66","L")
...
l1.SetFillColor(0)
l1.Draw("same")
outname = "plots/cpv_varyth23_2017.eps"
c1.SaveAs(outname)
...
h2 = c2.DrawFrame(-1.0,0.0,1.0,36.0)
...
graph_mhrange556.SetFillColorAlpha(ROOT.kCyan+1,0.25)
...
l1.Draw("same")
outname = "plots/mh_varyth23_2017.eps"
c2.SaveAs(outname)
